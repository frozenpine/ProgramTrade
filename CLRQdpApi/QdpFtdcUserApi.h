...
public:
	...
	///查询客户库存应答
	virtual void OnRspQryInventory(CQdpFtdcInventoryField *pInventory, CQdpFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
...
public:
	...
	///查询客户库存请求
	virtual int ReqQryInventory(CQdpFtdcQryInventoryField *pQryInventory, int nRequestID) = 0;
