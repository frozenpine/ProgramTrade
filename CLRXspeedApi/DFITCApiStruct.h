...
struct APISTRUCT DFITCInsertOrderField
{
    ...
    DFITCInstrumentIDType               instrumentID;                 //合约代码, 支持目前国内期货交易所的所有合约，包括大商所/郑商所的套利合约
...
struct APISTRUCT DFITCPricesTriggerField
{
    ...
    DFITCDateType                   validate;           //有效日期(yyyy.mm.dd,暂不支持)
...
struct APISTRUCT DFITCMatchTriggerField
{
    ...
    DFITCBuySellTypeType            buySellType;        //买卖标志
    DFITCOpenCloseTypeType          openCloseType; 	    //开平标志
    DFITCInstrumentIDType           trigInstrumentID;   //触发合约代码
...
struct APISTRUCT DFITCArbitrageField
{
    ...
    DFITCRequestIDType              lRequestID;         //请求ID 
    DFITCLocalOrderIDType           localOrderID;       //本地委托号
    DFITCInstrumentIDType           instrumentID;       //合约代码1
    DFITCInstrumentIDType           instrumentID2;      //合约代码2
    DFITCDateType                   validate;           //有效日期
...
struct APISTRUCT DFITCQryMatchTriggerField  
{
    ...
    DFITCAmountType                 cancelAmount;       //撤单数量
    DFITCSPDOrderIDType             spdOrderID;         //柜台委托号
    DFITCInstrumentIDType           trigInstrumentID;   //合约代码
    DFITCBuySellTypeType            trigBuySellType;    //买卖标志
    DFITCOpenCloseTypeType          trigOpenCloseType;  //开平标志
    DFITCSpeculatorType             trigSpeculator;     //投保类型
    DFITCPriceType                  trigInsertPrice;    //委托价格
...
struct APISTRUCT DFITCArbitrageRspField  
{
    ...
    DFITCSPDOrderIDType             extSpdOrderID;      //条件单编号
    DFITCInstrumentIDType           instrumentID;       //合约代码
    DFITCInstrumentIDType           instrumentID2;      //合约代码
    DFITCInstrumentIDType           instrumentID3;      //合约代码
    DFITCPriceType                  insertPrice;        //偏离板价
    DFITCAmountType                 orderAmount;        //委托数量
    DFITCSpeculatorType             speculator;         //投保类型
    DFITCBuySellTypeType            buySellType;        //买卖标志
